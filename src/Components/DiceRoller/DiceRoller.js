...
const DiceRoller = () => {
    ...
    // Array of dice types and their sides
    ...
    // Icons for each sided dice are set as an array to be used as radio buttons
    ...
    const rollDice = (dice) => {
        ...
        do {
            ...
            console.log(`Amount of dice: ${diceAmount} Total before modifier: ${baseRoll} D${dice} Rolled ${i + 1} dice`);
            i++
        } while (i < diceAmount);
        modifiedRoll = baseRoll + modifier;

        console.log(`${baseRoll} + ${modifier} = ${modifiedRoll}`)
        if (dice == 20 && baseRoll == 20) {
            modifiedRoll = 'Nat 20!';
        }
        if (dice == 20 && baseRoll == 1) {
            modifiedRoll = 'Nat 1';
        }
        setRoll(baseRoll);
        ...
        <div>
            <Form>
                ...
                <Form.Group className="pt-2">
                    ...
                    {/* Radio button uses icons array and values are set here */}
